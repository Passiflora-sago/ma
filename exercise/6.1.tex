...
\begin{solution}
    \begin{enumerate}
        ...
        \item 记$p = \frac{y}{x}$, 则$y = px$, $y' = p'x + p$. 代入方程得
              ...
              我们还是允许如下的表示$$y^2 = x^2 (2 \ln |x| + C), x \ne 0.$$
        \item 记$p = \frac{y}{x}$, 则$y = px$, $ y' = p'x + p$. 代入方程得
              \begin{align*}
              ...
              \end{align*}
              综上, 方程的解为
              $$ (y - x)^2 = C xy (y - 2x)^3, \quad 2y^2-xy \ne 0.$$
...
\begin{solution}
    \begin{enumerate}
        ...
        \item 将方程视为 $x$ 关于 $y$ 的函数. 原方程可写为 $\frac{\mathrm{d}x}{\mathrm{d}y} = \frac{x+y^3}{y} = \frac{x}{y} + y^2$.
              ...
              \end{align*}
              解为 $x = \frac{y^3}{2} + Cy, \quad C \in \mathbb{R}.$
        ...
        \item 这是 Bernoulli 方程. $y \equiv 0$ 是一个解. 当 $y \neq 0$ 时, 将方程整理为标准形式:
              ...
              通解为 $y=0$ 和 $y = \frac{\sec x+ \tan x}{\sin x + C}$.
    \end{enumerate}
\end{solution}
...
\begin{solution}
    \begin{enumerate}
        ...
        因此\begin{align*}
            ...
            \implies & y = \arccos \left( C' \e^{\frac{1}{2} x^2} - 1 \right) + 2k \pi, k \in \Z
        \end{align*}
    \end{enumerate}
\end{solution}

...
\begin{solution}
    \begin{enumerate}
        ...
        \item \begin{align*}
              ...
              \end{align*}
        \item \begin{align*}
                  \lim_{x \to 1^-} \frac{\ln(1 - x) + \tan \frac{\pi}{2} x}{\cot \pi x} & \stackrel{y=1-x}{=} \lim_{y \to 0^+} \frac{\ln y + \tan \frac{\pi}{2} (1-y)}{\cot \pi (1-y)} = \lim_{y \to 0^+} \frac{\ln y + \cot \frac{\pi}{2} (y)}{-\cot \pi y} \\
                & \stackrel{L'H}{=} \lim_{y \to 0^+} \frac{\frac{1}{y}-\frac{\pi}{2}\frac{1}{\sin^2 \frac{\pi}{2}y}}{\pi\frac{1}{\sin^2 \pi y}}=  \lim_{y \to 0^+}\left( \frac{\sin^2 \pi y}{\pi y}-\frac{ 1}{2}\frac{\sin^2 \pi y}{\sin^2 \frac{\pi}{2}y}\right)\\ 
                &=0-2 = -2
              \end{align*}
        \item \begin{align*}
                  \lim_{x \to 0} \frac{(\arcsin x^3)^2}{(1 - \cos x)(\mathrm{e}^{x^2} - 1) \tan^2 x} & = \lim_{x \to 0} \frac{(x^3)^2}{\frac{1}{2} x^2\cdot x^2\cdot x^2} = 2
              \end{align*}
        \item \begin{align*}
                  \lim_{x \to +\infty} \left(\frac{\ln (1+x)}{x}\right)^{1/x}       & = \exp\left(\lim_{x \to +\infty} \frac{\ln\ln(1+x)-\ln x}{x} \right) = 
                  \exp\left(\lim_{x \to +\infty} \frac{\frac{1}{\ln (1+x)}\frac{1}{1+x}-\frac{1}{x} }{1} \right)\\
                  &=\exp 0 = 1
              \end{align*}
        \item \begin{align*}
                  \lim_{x \to 0} \frac{\arctan x^2}{\sqrt{1 + x \sin x} - \sqrt{\cos x}} \cdot \left(2 - \frac{x}{\mathrm{e}^x - 1}\right) & = \lim_{x \to 0} \frac{x^2(\sqrt{1 + x \sin x} + \sqrt{\cos x})}{1 + x \sin x - \cos x} \cdot \lim_{x \to 0} \left(2 - \frac{x}{\mathrm{e}^x - 1}\right) \\
                                                                                                                                           & = \lim_{x \to 0} \frac{x^2\cdot (1 + 1)}{1 + x \sin x - \cos x} \cdot (2-1)                                                                        \\
                                                                                                                                           & = \lim_{x \to 0} \frac{4x}{\sin x+x\cos x+\sin x} = \lim_{x \to 0} \frac{4}{\frac{2\sin x}{x}+\cos x}= \frac{4}{3}
              \end{align*}
        \item 只需证明:$$\lim_{x \to + \infty} \frac{x^k}{a^x} = 0.$$
              再由Heine定理即得.

              对于$\lim_{x \to + \infty} \frac{x^k}{a^x}$
        ...
        \item 只需证明:$$\lim_{x \to + \infty} \frac{\ln x}{x^k} = 0.$$
              再由Heine定理即得.

              对于$\lim_{x \to + \infty} \frac{\ln x}{x^k}$
...
\begin{solution}
    \begin{enumerate}
        \item $\{x_n\}$ 是递减的, 因为 $x_{n+1} - x_n = f(x_n) - x_n < 0$. $\{x_n\}$ 具有下界 $0$, 故可设 $\{x_n\}$ 收敛到 $x$. 令 $n \to \infty$, 由 $f$ 的连续性, 得 $x = f(x)$, 同时利用夹逼准则可知$f(0)=0$是唯一满足$x = f(x)$的,故 $x = 0$.

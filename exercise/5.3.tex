...
\begin{exercise}[5.3.1]
    ...
    \begin{tasks}(1)
        ...
        \task Archimedes 螺线 $r = a\theta$ ($0 \les \theta \le 2\pi$).
    \end{tasks}
\end{exercise}
...
\begin{exercise}[5.3.2]
    ...
    \begin{tasks}(1)
        ...
        \task $\begin{cases} x = t - \sin t, \\ y = 1 - \cos t \end{cases}$ ($0 \les t \le 2\pi$) 及 $x$ 轴;
...
\begin{exercise}[5.3.3]
    ...
    \begin{tasks}(1)
        ...
        \task $y = \mathrm{e}^{x^2}$ ($0 \les x \le 1$) 与 $y$ 轴围成的图形绕 $y$ 轴旋转一周;
        \task $\begin{cases} x = t - \sin t, \\ y = 1 - \cos t \end{cases}$ ($0 \les t \le 2\pi$) 与 $x$ 轴围成的图形绕 $x$ 轴旋转一周.
    \end{tasks}
\end{exercise}
